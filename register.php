...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="login.html" class="h1"><b>Site</b>Bot</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Daftar akun Sitebot <br> (Registrasi akun hanya untuk dosen)</p>
      ...
      <a href="login.php" class="text-center">Sudah mempunyai akun Sitebot</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
